...
| ----- | ----- | ----- | ----- | ----- | ----- |
| `ble` | Various **B**luetooth **L**ow **E**nergy (BLE) commands.<br><br>Only available with tmo_shell version 1.10.x and later. Upgrade [here](09-Upgrading-your-IoT-Developer-Kit.md). | 1. smp<br>2. adv | 1. BLE SMP Controls<br>2. BLE advertisement test controls | | 1. `tmo ble adv ibeacon` |
...
| `certs` | CA cert commands. Load, list, or dump certificates of authority on to your kit.<br><br>Only available with tmo_shell version 1.10.x and later. Upgrade [here](09-Upgrading-your-IoT-Developer-Kit.md). | 1. list<br>2. dump<br>3. load | 1. List certificates.<br>2. Dump certificates<br>3.Load certificates | | 1. `tmo certs list`<br>2. `tmo certs dump` | 
